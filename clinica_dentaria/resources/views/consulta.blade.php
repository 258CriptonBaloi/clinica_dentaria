    ...
    <section id="contact" class="contact">
        <div class="container">
          ...
          <div class="section-title">
            <h2 style="margin-top: 70px;">Marcar Consulta</h2>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="info-box">
                    ...
                    <p>📍MAPUTO - Av. Olof Palme, nr. 941, 1andar</p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="info-box mt-4">
                    ...
                    <h3>
                        Envia-nos um email</h3>
                    <p>dentalhome.mz@gmail.com<br>dentalhome.mz@gmail.com</p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="info-box mt-4">
                    ...
                    <p>  
                        +258 872997777- MAPUTO <br>+258 862997777 - INHAMBANE</p>
                  </div>
                </div>
              </div> -->
              ...
              <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                <div class="row">
                  ...
                  <div class="col-md-4 form-group mt-3 mt-md-0">
                    <input type="text" class="form-control" name="email" id="email" placeholder="Contacto" required="">
                  </div>
                  <div class="col-md-4 form-group mt-3 mt-md-0">
                    <input type="email" class="form-control" name="email" id="email" placeholder="Email" required="">
                  </div>
                  <div class="col-md-4 form-group mt-3 mt-md-3">
                    <input type="date" class="form-control" name="email" id="email" placeholder="Email" required="">
                  </div>
                  <div class="col-md-4 form-group mt-3 mt-md-3">
                    <select class="form-select form-select-sm" aria-label=".form-select-sm example">
                        <option selected>Motivo da consulta *</option>
                        <option value="1">Dor de dente</option>
                        <option value="2">Chumbar dente</option>
                        <option value="3">Fazer limpeza nos dentes</option>
                        <option value="1">Branqueiar dentes</option>
                        <option value="2">Sangramento das gengivas</option>
                        <option value="3">Fazer Prótese Dentária</option>
                        <option value="1">Fazer implate</option>
                        <option value="2">Tirar dente</option>
                        <option value="3">Outros</option>
                      </select>
                  </div>
                  <div class="col-md-4 form-group mt-3 mt-md-3">
                    <select class="form-select form-select-sm" aria-label=".form-select-sm example">
                        <option selected>Hora pretendida *</option>
